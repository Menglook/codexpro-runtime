...
[English](README.md) · [快速开始](docs/quickstart.md) · [证据演示](docs/demo.md) · [发布就绪](docs/release-readiness.md) · [架构](docs/architecture.md) · [安全模型](docs/security-model.md) · [Codex Security 案例](docs/codex-security-case.md) · [治理](GOVERNANCE.md) · [路线图](ROADMAP.md) · [贡献指南](CONTRIBUTING.md) · [采用证据](docs/adoption.md)
